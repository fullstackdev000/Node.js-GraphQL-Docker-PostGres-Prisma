import { Country, Currency, State } from '#veewme/gen/graphqlTypes'

export type CountriesOptions = Array<{ label: string, value: Country }>
export const Countries: CountriesOptions = [
...
{ label: 'Plurinational State of Bolivia', value: 'BO' },
{ label: 'Sint Eustatius and Saba Bonaire', value: 'BQ' },
...
export type StatesOptions = Array<{ label: string, value: State }>
export const States: StatesOptions = [
...
export type CurrencyOptions = Array<{ label: string, value: Currency }>
